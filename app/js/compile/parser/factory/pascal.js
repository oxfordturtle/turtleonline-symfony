...
export const constant = (lexemes, lex, routine) => {
  ...
  const value = evaluate(identifier, valueLexemes, routine)
...
export const variables = (lexemes, lex, routine, parameter = false, byref = false) => {
  ...
  const result = fulltype(lexemes, lex, routine, parameter, byref)
...
export const subroutine = (lexemes, lex, type, parent) => {
  ...
  const subroutine = factory.subroutine(identifier.content, type, parent)
