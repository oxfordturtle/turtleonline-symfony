...
import { VariableAddress, VariableValue } from '../parser2/definitions/expression'
import { Statement, VariableAssignment, ProcedureCall, IfStatement, ForStatement, RepeatStatement, WhileStatement, ReturnStatement } from '../parser2/definitions/statement'
...
export default function statement (stmt: Statement, program: Program, startLine: number, options: Options): number[][] {
  ...
  if (stmt instanceof ProcedureCall) {
